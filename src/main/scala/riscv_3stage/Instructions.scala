...
object Instructions {
  ...
  // Synch
  def FENCE: BitPat = BitPat("b0000????????00000000000000001111")
  def FENCEI: BitPat = BitPat("b00000000000000000001000000001111")
  // CSR Access
  ...
  def WFI: BitPat = BitPat("b00010000001000000000000001110011")
