...
object Control {
  ...
  // pc_sel
  val PC_4: UInt = 0.U(2.W)
  val PC_ALU: UInt = 1.U(2.W)
  val PC_0: UInt = 2.U(2.W)
  val PC_EPC: UInt = 3.U(2.W)

  // A_sel
  val A_XXX: UInt = 0.U(1.W)
  val A_PC: UInt = 0.U(1.W)
  val A_RS1: UInt = 1.U(1.W)

  // B_sel
  val B_XXX: UInt = 0.U(1.W)
  val B_IMM: UInt = 0.U(1.W)
  val B_RS2: UInt = 1.U(1.W)

  // imm_sel
  val IMM_X: UInt = 0.U(3.W)
  val IMM_I: UInt = 1.U(3.W)
  val IMM_S: UInt = 2.U(3.W)
  val IMM_U: UInt = 3.U(3.W)
  val IMM_J: UInt = 4.U(3.W)
  val IMM_B: UInt = 5.U(3.W)
  val IMM_Z: UInt = 6.U(3.W)

  // br_type
  val BR_XXX: UInt = 0.U(3.W)
  val BR_LTU: UInt = 1.U(3.W)
  val BR_LT: UInt = 2.U(3.W)
  val BR_EQ: UInt = 3.U(3.W)
  val BR_GEU: UInt = 4.U(3.W)
  val BR_GE: UInt = 5.U(3.W)
  val BR_NE: UInt = 6.U(3.W)

  // st_type
  val ST_XXX: UInt = 0.U(2.W)
  val ST_SW: UInt = 1.U(2.W)
  val ST_SH: UInt = 2.U(2.W)
  val ST_SB: UInt = 3.U(2.W)

  // ld_type
  val LD_XXX: UInt = 0.U(3.W)
  val LD_LW: UInt = 1.U(3.W)
  val LD_LH: UInt = 2.U(3.W)
  val LD_LB: UInt = 3.U(3.W)
  val LD_LHU: UInt = 4.U(3.W)
  val LD_LBU: UInt = 5.U(3.W)

  // wb_sel
  val WB_ALU: UInt = 0.U(2.W)
  val WB_MEM: UInt = 1.U(2.W)
  val WB_PC4: UInt = 2.U(2.W)
  val WB_CSR: UInt = 3.U(2.W)
...
class ControlSignals(val xlen: Int) extends Bundle{
...
class Control(implicit xlen: Int) extends Module {
  val io: ControlSignals = IO(new ControlSignals(xlen))
  val ctrlSignals: List[UInt] = ListLookup(io.inst, Control.default, Control.map)
