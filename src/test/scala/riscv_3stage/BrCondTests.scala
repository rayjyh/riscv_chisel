...
class BrCondTests extends org.scalatest.FlatSpec {
  ...
  "BrCond" should "pass" in {
    assert(TesterDriver execute (() => new BrCondTester(new BrCond)))
  }
}
